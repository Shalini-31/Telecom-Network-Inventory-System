...
public class ViewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<body>");
        out.println("<header>");
        out.println("<h1>Manage Inventory</h1>");
        out.println("</header>");
        out.println("<nav>");
        out.println("<ul>");
       ...
       // out.println("<a href='index.html' class='btn'>Add</a>");
        out.println("<a href='ViewServlet' class='btn'>Back</a>");
        out.println("</form>");
        out.println("</div>");
 
        // Retrieve filtered list of components
        List<Emp> list = EmpDao.getAllComponents(search, typeFilter, statusFilter, locationFilter); // Added location filter
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            out.print("<tr class='" + rowClass + "'><td>" + e.getCid() + "</td><td>" + e.getType() + "</td><td>" + e.getModel() + "</td><td>" + e.getStatus() + "</td><td>" + e.getLocation() + "</td><td>" + e.getVid() + "</td><td><a href='EditServlet?cid=" + e.getCid() + "' class='btn btn-edit'>Edit</a></td><td><a href='DeleteServlet?cid=" + e.getCid() + "' class='btn btn-delete' onclick='return confirmDelete()'>Delete</a></td></tr>");
        }
        out.print("</table>");
