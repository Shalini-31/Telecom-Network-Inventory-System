    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            try (Connection connection = Databaseconnection.initializeDataBase();
                ...
                out.println("<table>");
                out.println("<tr><th>Viewer List</th><th>Action</th></tr>");
                while (resultSet.next()) {
                	
                    out.println("<tr><td>" + resultSet.getString(1) + "</td><td><form method='post' action ='deleteViewer'><input type='hidden' id='username' name='username' value="+resultSet.getString(1)+"><input type='submit' value='Delete'/></form></td></tr>");
                }
                out.println("</table>");
            } catch (Exception e) {
