...
public class DisplayOperator extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            out.println("<table>");
            out.println("<tr><th>Operator List</th><th>Action</th></tr>");
            ...
            for (String operator : operators) {
            	 out.println("<tr><td>" + operator + "</td><td><form method='post' action ='deleteOperator'><input type='hidden' id='username' name='username' value="+ operator +"><input type='submit' value='Delete'/></form></td></tr>");
            }
            out.println("</table>");
